# HystGNet: Generalizable Hysteresis Analysis of Precast Joints

Official implementation of the deep learning framework for predicting the hysteresis behavior of varying post-cast precast beam-column joints.
This repository contains the model architecture and training scripts for the paper accepted in the Journal of Building Engineering.
...
For questions regarding the code or the paper, please contact:
230239458@seu.edu.cn (Shunyao Wang, Ph.D. student at Southeast University)
